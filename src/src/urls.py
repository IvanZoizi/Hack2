...
from main.views import main_view, main_view_2
from reg.views import RegisterView, sign_in, logout_user
from src import settings
from buy.views import buy_first_dish, buy_second_dish, buy_third_dish, buy_fours_dish, buy_fives_dish, confirm, success, business, buy_business
...
urlpatterns = [
    ...
    path('buy/business/', business),
    path('buy/business/<int:pk>', buy_business)
